  ...
  <div class="flex flex-wrap justify-center ">
    <div class="w-2/3 sm:w-1/2 md:w-5/12 lg:w-4/12 mb-12 hover-grayscale-0">
      <div class="flex items-center relative"> 
        <div class="absolute border-l-2 border-gray-800 h-3/4 right-0 top-0 bottom-0 mx-2"></div>
        <img src="/avatar1.png" class=" w-8/12 h-auto mx-auto rounded-full grayscale" alt="title image">
      </div>
    </div>
